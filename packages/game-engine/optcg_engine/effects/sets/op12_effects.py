...
# =============================================================================
# OP12 GENERIC FALLBACK REGISTRATIONS
# =============================================================================

from .generic_fallback import register_generic_set_fallback


_OP12_GENERIC_TIMINGS = {
    "OP12-007": ['on_play'],
    "OP12-008": ['on_opponent_attack', 'blocker'],
    "OP12-012": ['on_play', 'blocker'],
    "OP12-013": ['activate'],
    "OP12-016": ['counter', 'on_play', 'blocker'],
    "OP12-018": ['counter'],
    "OP12-019": ['counter', 'on_play'],
    "OP12-021": ['blocker'],
    "OP12-024": ['on_attack'],
    "OP12-026": ['activate'],
    "OP12-027": ['blocker'],
    "OP12-029": ['on_play'],
    "OP12-030": ['on_play', 'blocker'],
    "OP12-031": ['on_play'],
    "OP12-033": ['on_block', 'blocker'],
    "OP12-036": ['continuous'],
    "OP12-037": ['counter', 'on_play'],
    "OP12-038": ['counter', 'on_play'],
    "OP12-039": ['on_play', 'trigger'],
    "OP12-042": ['on_play'],
    "OP12-043": ['on_play'],
    "OP12-044": ['on_play', 'activate'],
    "OP12-046": ['on_play', 'activate'],
    "OP12-048": ['continuous'],
    "OP12-050": ['blocker'],
    "OP12-051": ['activate', 'blocker'],
    "OP12-057": ['counter', 'trigger'],
    "OP12-058": ['on_play', 'trigger'],
    "OP12-059": ['counter', 'on_play'],
    "OP12-062": ['on_play'],
    "OP12-063": ['blocker'],
    "OP12-065": ['on_ko', 'blocker'],
    "OP12-066": ['blocker'],
    "OP12-069": ['on_opponent_attack'],
    "OP12-070": ['continuous'],
    "OP12-072": ['continuous'],
    "OP12-073": ['on_play'],
    "OP12-074": ['on_play'],
    "OP12-075": ['on_play', 'trigger'],
    "OP12-077": ['on_play', 'blocker', 'trigger'],
    "OP12-078": ['on_play'],
    "OP12-080": ['trigger'],
    "OP12-084": ['on_play', 'blocker'],
    "OP12-085": ['on_attack'],
    "OP12-087": ['on_play', 'blocker'],
    "OP12-089": ['on_ko', 'blocker'],
    "OP12-090": ['on_attack'],
    "OP12-091": ['activate'],
    "OP12-093": ['continuous'],
    "OP12-094": ['on_play'],
    "OP12-095": ['on_play'],
    "OP12-096": ['on_play', 'trigger'],
    "OP12-097": ['trigger'],
    "OP12-098": ['counter', 'trigger'],
    "OP12-099": ['continuous'],
    "OP12-101": ['activate', 'trigger'],
    "OP12-102": ['continuous'],
    "OP12-104": ['trigger'],
    "OP12-105": ['on_play'],
    "OP12-106": ['blocker'],
    "OP12-109": ['trigger'],
    "OP12-112": ['trigger'],
    "OP12-113": ['on_ko', 'trigger'],
    "OP12-116": ['trigger'],
    "OP12-117": ['counter', 'on_play'],
    "OP12-118": ['on_play', 'blocker'],
    "OP12-119": ['on_play', 'on_ko'],
}


register_generic_set_fallback(_OP12_GENERIC_TIMINGS, "OP12")
